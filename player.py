...
class Player(sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.onGround = False  # На земле ли модель
        ...
        if up:
            if self.onGround:
                ...
                if running and (left or right):
                        # если есть ускорение и мы движемся
        ...
        if left:
            ...
            if running:  # если усkорение
                ...
                if not up:  # и если не прыгаем
                    ...
                    # то отображаем быструю анимацию
            else:  # если не бежим
                if not up:  # и не прыгаем
                    self.boltAnimLeft.blit(self.image, (0, 0))
                    # отображаем анимацию движения
            if up:  # если же прыгаем
                    self.boltAnimJumpLeft.blit(self.image, (0, 0))
                    # отображаем анимацию прыжка
